...
@section('Contenido')
	...
	<!-- Page top section -->
	<section class="page-top-section set-bg" data-setbg="{{ asset('Home/img/page-top-bg/banner2.png') }}">
		<div class="page-info">
            <br><br><br><br><br>
			...
			<div class="row">
				<div class="col-lg-7 order-2 order-lg-1">
					<form class="contact-form">
						...
						<button class="site-btn">Enviar Mensaje<img src="{{ asset('Home/img/icons/double-arrow.png') }}" alt="#"/></button>
					</form>
				</div>
				<div class="col-lg-5 order-1 order-lg-2 contact-text text-white">
					...
					<div class="cont-info">
						<div class="ci-icon"><img src="{{ asset('Home/img/icons/location.png') }}" alt=""></div>
						<div class="ci-text">Álvarez 2336, Viña del Mar, Valparaíso</div>
					</div>
					<div class="cont-info">
						<div class="ci-icon"><img src="{{ asset('Home/img/icons/phone.png') }}" alt=""></div>
						<div class="ci-text">+569 87621595</div>
					</div>
					<div class="cont-info">
						<div class="ci-icon"><img src="{{ asset('Home/img/icons/mail.png') }}" alt=""></div>
